...
Switch Settings\n1-4 ROM Address (OFF == 1)\n5 A14 Enable (OFF == enabled)\n6 A13 (OFF == enabled)\n7 ROM Enable (OFF == enabled)\n8 Write Enable (OFF == enabled)
...
U 1 1 572A7FE2
P 1050 8050
F 0 "#PWR07" H 1050 8050 30  0001 C CNN
...
U 1 1 572AAEEC
P 1950 7800
F 0 "#PWR08" H 1950 7900 30  0001 C CNN
F 1 "VCC" H 1950 7900 30  0000 C CNN
...
ROM Address Notes:\nFor full 32K device (28C256) set S1 3,4,5,6 ON\nFor 8K device (28C64B) set S1 5,6 OFF\nS1 3,4 become address switches
...
U 1 1 573048DB
P 1050 4850
F 0 "#PWR012" H 1050 4850 30  0001 C CNN
...
U 1 1 5730495B
P 1950 4650
F 0 "#PWR013" H 1950 4750 30  0001 C CNN
